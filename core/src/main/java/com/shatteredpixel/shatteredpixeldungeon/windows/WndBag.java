...
public class WndBag extends WndTabbed {
	...
	protected void placeItems( Bag container ) {
		...
		placeItem( stuff.artifact1 != null ? stuff.artifact1 : new Placeholder( ItemSpriteSheet.ARTIFACT_HOLDER ) );
		placeItem( stuff.artifact2 != null ? stuff.artifact2 : new Placeholder( ItemSpriteSheet.ARTIFACT_HOLDER ) );
		placeItem( stuff.artifact3 != null ? stuff.artifact3 : new Placeholder( ItemSpriteSheet.ARTIFACT_HOLDER ) );
