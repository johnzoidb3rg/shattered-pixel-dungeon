...
import com.shatteredpixel.shatteredpixeldungeon.items.bags.JewelryBox;
...
public class InventoryPane extends Component {
	...
	public void updateInventory(){
		...
		equipped.get(2).item(stuff.artifact1 == null ? new WndBag.Placeholder( ItemSpriteSheet.ARTIFACT_HOLDER ) : stuff.artifact1);
		equipped.get(3).item(stuff.artifact2 == null ? new WndBag.Placeholder( ItemSpriteSheet.ARTIFACT_HOLDER ) : stuff.artifact2);
		equipped.get(4).item(stuff.artifact3 == null ? new WndBag.Placeholder( ItemSpriteSheet.ARTIFACT_HOLDER ) : stuff.artifact3);
