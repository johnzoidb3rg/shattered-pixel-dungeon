...
public class InventoryPane extends Component {
	...
	public void updateInventory(){
		...
		equipped.get(2).item(stuff.misc1 == null ? new WndBag.Placeholder( ItemSpriteSheet.SOMETHING ) : stuff.misc1);
		equipped.get(3).item(stuff.misc2 == null ? new WndBag.Placeholder( ItemSpriteSheet.SOMETHING ) : stuff.misc2);
		equipped.get(4).item(stuff.misc3 == null ? new WndBag.Placeholder( ItemSpriteSheet.SOMETHING ) : stuff.misc3);
